...
#include <vision_gate/gateConfig.h>
...
void callback(vision_gate::gateConfig &config, uint32_t level)
{
...
int main(int argc, char *argv[])
{
  ...
  dynamic_reconfigure::Server<vision_gate::gateConfig> server;
  dynamic_reconfigure::Server<vision_gate::gateConfig>::CallbackType f;
